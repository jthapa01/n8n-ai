...
export const EditorBreadCrumns = ({ workflowId }: { workflowId: string }) => {
    return (
        <Breadcrumb>
            <BreadcrumbList>
                <BreadcrumbItem>
...
export const EditorHeader = ({ workflowId }: { workflowId: string }) => {
    return (
        <header className="flex shrink-0 items-center gap-2 px-4 h-14 border-b bg-background">
            <SidebarTrigger />
            <div className="flex flex-row items-center justify-between gap-x-4 w-full">
                <EditorBreadCrumns workflowId={workflowId} />

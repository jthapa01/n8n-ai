...
import { ArrowLeftIcon, CheckCircle2Icon, ClockIcon, Loader2Icon, XCircleIcon } from "lucide-react";
...
export const ExecutionView = ({ executionId }: { executionId: string }) => {
    ...
    const [showStackTrace, setShowStackTrace] = useState(false); // For toggling the visibility of the error stack trace
            ...
            <Card className="shadow-none">
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <p className="text-sm text-muted-foreground font-medium">Event ID</p>
                        ...
                        <div className="mt-6 p-4 bg-red-50 rounded-md space-y-3">
                            ...
                            {execution.errorStack && (
                                <Collapsible open={showStackTrace} onOpenChange={setShowStackTrace}>
                                    ...
                                    <CollapsibleContent>
                                        <pre className="text-xs text-red-800 overflow-auto mt-2 p-2 bg-red-100 font-mono">{execution.errorStack}</pre>
                                    </CollapsibleContent>
                                </Collapsible>
                            )}
                        </div>

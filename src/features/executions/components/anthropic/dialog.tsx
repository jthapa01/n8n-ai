...
export const AnthropicDialog = ({ open, onOpenChange, onSubmit, defaultValues = {} }: Props) => {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Configure Anthropic Node</DialogTitle>
                    <DialogDescription>
                        Configure the Anthropic AI model settings for this node.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder="e.g. myAnthropic" {...field} />
                                    </FormControl>
                                    <FormDescription>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Sets the behavior of the assistant. Use {"{{variables}}"} for simple values or {"{{json variable}}"} for JSON objects.
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
